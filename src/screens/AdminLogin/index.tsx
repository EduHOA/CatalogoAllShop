...
export default function AdminLogin() {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-dark p-4">
      <div className="bg-black/30 p-8 rounded-2xl border border-primary/20 backdrop-blur-sm w-full max-w-md">
        <div>
          <img
